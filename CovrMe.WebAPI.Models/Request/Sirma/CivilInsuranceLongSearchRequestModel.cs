...
{
    public class CivilInsuranceLongSearchRequestModel
    {
        public CivilInsuranceLongSearchRequestModel()
        {
            //this.Insurers = new List<string>();
            this.VehicleNoRegNum = 0;
        }
        ...
        public string? BirthdateUsual { get; set; } = string.Empty;
        ...
        [JsonProperty("owner_guilt")]
        public int OwnerGuilt { get; set; }

        [JsonProperty("usual_guilt")]
        ...
        [JsonProperty("vehicle_kilowatts")]
        public int VehicleKilowatts { get; set; }

        [JsonProperty("no_reg_num")]
        public int VehicleNoRegNum { get; set; }
