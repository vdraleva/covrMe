...
{
    public class CountryTelCodeHelper
    {
        public List<CountryTelCode> TelCodes { get; set; }

        public CountryTelCodeHelper()
        {
        ...
        public string GetPhoneCodeByCountryShortCode(string countryShortCode)
        {
            var countryTelCode = TelCodes.FirstOrDefault(c => c.CountryShortCode == countryShortCode);
            return countryTelCode?.PhoneCode ?? string.Empty;
        }
    }
}
