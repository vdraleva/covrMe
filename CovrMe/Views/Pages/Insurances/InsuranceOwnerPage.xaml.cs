...
public partial class InsuranceOwnerPage : ContentPage
{
    public InsuranceOwnerPageViewModel viewModel;
    public InsuranceOwnerPage(InsuranceOwnerPageViewModel vm, Dictionary<string, object> parameters)
    {
        InitializeComponent();
        ...
        if (viewModel.ShowInsurerCheckBox)
        {
