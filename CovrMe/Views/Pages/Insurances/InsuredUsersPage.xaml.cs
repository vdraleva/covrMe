...
public partial class InsuredUsersPage : ContentPage
{
    private InsuredUsersPageViewModel viewModel;
    public InsuredUsersPage(InsuredUsersPageViewModel vm, Dictionary<string, object> parameters)
	{
        InitializeComponent();
