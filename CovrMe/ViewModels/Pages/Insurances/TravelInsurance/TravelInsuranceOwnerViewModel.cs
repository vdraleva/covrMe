...
{
    public partial class TravelInsuranceOwnerViewModel : BaseViewModel, IQueryAttributable
    {
        #region Fields
        ...
        public TravelInsuranceOwnerViewModel(ILocationService locationService, IUserService userService)
        {
        ...
        private async void Continue()
        {
            try
            {
                ...
                await Navigation.PushAsync<TravelInsuredUsersPage>(parameters);
        ...
        public async Task GetCurrentUserInfo()
        {
            if (!string.IsNullOrEmpty(App.UserId))
            {
                ...
                if (currentUser != null)
                {
                    ...
                    this.SurName = currentUser.LatinSurName;
                    this.LastName = currentUser.LatinLastName;
                    this.VatNumber = currentUser.VatNumber;
                    this.Uin = currentUser.UiNumber;
                    this.Address = currentUser.LatinAddress;
                    this.CompanyName = currentUser.LatinCompanyName;
            ...
            if (!string.IsNullOrEmpty(App.UserId))
            {
                ...
                foreach (var user in users.FamilyAndFriends)
                {
                    var current = new UserFamilyAndFriendsPicker
                    {
                        ...
                        CompanyName = user.LatinCompanyName,
        ...
        private ValidationModel ValidateInput()
        {
            ...
            {
                var valid = this.ValidateLatin(this.FirstName.TrimEnd());
            ...
            {
                var valid = this.ValidateLatin(this.SurName.TrimEnd());
            ...
            {
                var valid = this.ValidateLatin(this.LastName.TrimEnd());
            ...
            if (!string.IsNullOrEmpty(this.CompanyName))
            {
                ...
                {
                    var valid = this.ValidateLatinCompany();
        ...
        private bool ValidateLatinCompany()
        {
            if (Regex.IsMatch(this.CompanyName.TrimEnd(), GlobalConstants.LatinCompanyRegex))
            {
                return true;
            }
        ...
        {
            if (Regex.IsMatch(this.Address.TrimEnd(), GlobalConstants.LatinAddressRegex))
            {
                return true;
            }
        ...
        private bool PhoneValidation()
        {
            if (!string.IsNullOrEmpty(this.Phone))
            {
                if (Regex.IsMatch(this.Phone, GlobalConstants.PhoneRegex))
                {
                    return true;
                }
            }
        ...
        private async Task<UserModel> EditUserInfo(string userId = null)
        {
            ...
            var req = new EditUserInfoInput
            {
                ...
                LatinFirstName = this.FirstName.TrimEnd(),
                LatinSurName = this.SurName.TrimEnd(),
                LatinLastName = this.LastName.TrimEnd(),
                LatinAddress = this.Address.TrimEnd(),
                ...
                VatNumber = string.IsNullOrEmpty(this.VatNumber) ? null : this.VatNumber.TrimEnd(),
                BirthDate = this.BirthDate,
                LatinCompanyName = string.IsNullOrEmpty(this.CompanyName) ? null : this.CompanyName.TrimEnd(),
