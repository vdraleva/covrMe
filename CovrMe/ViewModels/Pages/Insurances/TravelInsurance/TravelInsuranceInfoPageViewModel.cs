...
{
    public partial class TravelInsuranceInfoPageViewModel : BaseViewModel, IQueryAttributable
    {
        #region Fields
        ...
        #endregion
        public TravelInsuranceInfoPageViewModel()
        {
        ...
        private async void Continue()
        {
            try
            {
                ...
                await Navigation.PushAsync<TravelInsuranceOwnerPage>(parameters);
            }
            catch (Exception ex)
            {
        ...
        public void ApplyQueryAttributes(IDictionary<string, object> query)
        {
            ...
            this.LimitFormatted = Helpers.FormatNumbers(this._selectedOffer.TravelInsuranceInfo.Limit) + " €";
        }
